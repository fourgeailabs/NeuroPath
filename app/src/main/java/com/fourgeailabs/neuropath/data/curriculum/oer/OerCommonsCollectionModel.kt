...
data class OerMediaResource(
    ...
    val creatorOrSource: String = "NeuroPath built-in curriculum",
...
data class OerCommonsCurriculumItem(
    ...
    val openLicense: String = "Built-in curriculum content; original OER Commons resources carry their own licences",
    val summary: String,
