...
data class ChildProfileEntity(
    ...
    val neurodivergentTypesCsv: String = "",
    val strugglesCsv: String = "",
    val strengthsCsv: String = "",
    val hyperFixationsCsv: String = "",
    ...
    val customAiPlatform: String = "Llama 3.2 3B (Hugging Face)",
...
data class ChatMessageEntity(
    ...
    val modelUsed: String = "Llama-3.2-3B-Instruct",
