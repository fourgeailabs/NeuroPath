...
data class LocaleLegalNotice(
    ...
    val internetAccessNotice: String get() = termsSections.find { it.title.contains("Internet", ignoreCase = true) }?.content
        ?: "Internet access is used at defined points during app execution solely to connect to Cloud Artificial Intelligence services (Hugging Face Llama 3.2 3B) for real-time speech processing, tutoring hints, and curriculum updates."
    ...
    private fun getUSNotice() = LocaleLegalNotice(
        ...
        termsSections = listOf(
            ...
            LocaleTermsSection(
                ...
                content = "Internet access is used at defined points during app execution solely to connect to Cloud Artificial Intelligence services (Hugging Face Llama 3.2 3B) for real-time speech-to-text transcription, adaptive neurodivergent scaffolding, and synchronizing accredited curriculum updates."
            ),
            LocaleTermsSection(
